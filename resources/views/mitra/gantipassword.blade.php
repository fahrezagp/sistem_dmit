							...
							<div class="profile-left">
								<div class="profile-header">
									<div class="profile-main">
										...
										<h3 class="name">{{$user->mitra->nama}}</h3>
									</div>
								</div>
							</div>
								...
								<div class="profile-detail">
									<div class="profile-info">
										<div class=" table-responsive">
                                            <form action="/mitra/{{$user->id}}/simpanpassword" method="post">
                                                {{ csrf_field() }}
                                                @method("PATCH")
                                                ...
                                                <tbody>
                                                   ...
                                                   @enderror
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="password" name="password_baru" id="password_baru" class="form-control"></td>
                                                        @error('password')
                                                        <div class="text-danger mt-2">{{$message}}</div>
                                                   @enderror
                                                    </tr>
